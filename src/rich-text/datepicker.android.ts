...
export class DatePickerDialog
    ...
    implements android.app.DatePickerDialog.OnDateSetListener, android.content.DialogInterface.OnDismissListener, android.content.DialogInterface.OnShowListener
{
    constructor(private owner: WeakRef<EditableTextBase>) {
        super();
        return global.__native(this);
